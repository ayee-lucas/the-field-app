...
export default async function Page({
  ...
  const chatData: TextBubbleData[] = [
    ...
    {
      _id: '3',
      content: 'Yo todo bien y tu?',
      date: '9 min ago',
      type: 'sent',
    },
    {
      _id: '4',
      content: 'Todo bien bro',
      date: '8 min ago',
      type: 'received',
    },
    {
    ...
    },
    {
      _id: '7',
      content:
        'Estoy haciendo una tarea de matemáticas que me dejaron para mañana, y tu que haces?',
      date: '7 min ago',
      type: 'sent',
    },
    {
      _id: '8',
      content: 'Estoy en el trabajo',
      date: '6 min ago',
      type: 'received',
    },
    {
      _id: '9',
      content: 'Mañana voy a descansar, quieres salir a jugar futbol?',
      date: '6 min ago',
      type: 'received',
    },
    {
      _id: '10',
      content: 'Esta bien, a que hora?',
      date: '4 min ago',
      type: 'sent',
    },
    {
      _id: '11',
      content: 'A las 4pm ven a mi colonia',
      date: '4 min ago',
      type: 'received',
    },
    {
      _id: '12',
      content: 'Bueno ahi estaré, llevaré mi balón',
      date: '3 min ago',
      type: 'sent',
    },
    {
      _id: '13',
      content: 'Tienes zapatos que me prestes?',
      date: '3 min ago',
      type: 'sent',
    },
    {
      _id: '14',
      content: 'No tengo los mios',
      date: '3 min ago',
      type: 'sent',
    },
    {
      _id: '15',
      content: 'Noo no tengo, pero se los pediré a un amigo',
      date: '2 min ago',
      type: 'received',
    },
    {
      _id: '16',
      content: 'Bueno, pidele que me los preste un rato',
      date: '1 min ago',
      type: 'sent',
    },
    {
    ...
    {
      _id: '18',
      content: 'Te escribo cuando los tenga',
      date: 'just now',
      type: 'received',
    },
  ];

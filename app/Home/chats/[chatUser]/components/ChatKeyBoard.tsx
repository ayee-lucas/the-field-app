      ...
      <div className="flex w-full py-4">
        <div className="w-[80%] h-full pl-3 flex items-center">
          <textarea
            ...
            rows={1}
            className="w-full pl-3 text-sm dark:bg-black text-zinc-600 dark:text-gray-300 border border-zinc-400 dark:border-zinc-600 rounded-xl focus:border-zinc-500 dark:focus:border-zinc-500 focus:outline-none"

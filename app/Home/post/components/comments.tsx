...
const Comments = () => (
  <div className="w-full h-full flex flex-col items-center py-2 px-2 mt-3 border border-gray-200">
    ...
    <span className="text-sm text-gray-600 w-full h-full text-center py-1 bg-gray-200 hover:bg-gray-300 cursor-pointer" role="button">Show 23 replies</span>

...
export default async function Page() {
  ...
  return (
    <div
      className={`min-h-screen w-full grid grid-cols-2 max-sm:grid-cols-1 bg-black ${montserrat.variable}`}
    >
      <div className="w-full h-full flex flex-col items-center justify-center bg-white dark:bg-black max-sm:px-3">
        {/** Container */}
        <div
          className="min-w-[300px] max-sm:w-full min-h-[300px] w-[500px] h-[550px] px-3 bg-white
        ...
        >
          ...
          <h3 className="font-medium text-xl ml-1 font-montserrat">
            WELCOME BACK!
          </h3>
          <SignInForm />
          <GoogleLogin />

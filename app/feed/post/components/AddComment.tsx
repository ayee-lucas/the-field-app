...
const AddComment = ({ postAuthor }: { postAuthor: string }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`w-full max-w-[98%] transition-all h-auto flex flex-col gap-3 justify-center items-center border-t max-sm:border-t-0 mt-3 py-2 px-2 ${
          comment
            ? 'border-fieldGreen'
      ...
      >
          ...
          <div>
            ...
            {comment ? (
              <span
                className={
                  charCount <= 300
                    ? 'text-sm text-gray-400 w-full text-start'
                    : 'text-sm text-red-500 w-full text-start'
                }
              >
                {charCount}
                /300
        ...
        {comment ? (
          <div className="w-full flex relative justify-between  items-center">
            ...
            {emojis ? (
              <div className="absolute w-full h-full mt-10 ml-5">
                <EmojiPicker />
              </div>
            ) : null}
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                type="button"
                className="bg-fieldGreen text-white text-sm px-2 max-sm:px-5 max-sm:py-2 py-1 rounded-md flex items-center gap-2"
              >

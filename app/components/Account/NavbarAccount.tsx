...
const NavbarAccount = () => {
  return (
    ...
    >
      <div className="w-full min-h-[40px] bg-gray-100 after:content-[''] after:bg-fieldGreen after:h-[4px] after:w-full after:absolute after:left-0">
        <h1 className="text-xl font-roboto p-4 font-medium">
          ACCOUNT <span className="text-fieldGreen">SETTINGS</span>
        </h1>
      </div>
      <nav className="w-full p-3 pt-6 bg-zinc-200 shadow-lg">
